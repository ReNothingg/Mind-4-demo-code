...
from openai_harmony import load_harmony_encoding, HarmonyEncodingName # pip install openai-harmony
# Ну типо писать свой форматчик ответов не хочется
...
harmony_encoding = load_harmony_encoding(HarmonyEncodingName.HARMONY_mind-four)

o200k_mindfour = tiktoken.Encoding(
    name="o200k_mindfour",
...
mindfour_MODEL_UUID = UUID('df52dc86-1789-4ed0-a295-66f10508145b').bytes
