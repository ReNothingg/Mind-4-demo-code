...
from mindfour.metal import Context, Model

root = Path(__file__).resolve().parents[2]
DEFAULT_PROMPT = (root / "main.md").read_text(encoding="utf-8").format(date=date)

parser = argparse.ArgumentParser(description="Chat with mind-four", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument("model", metavar="PATH", type=str, help="Path to mind-four model in Metal inference format")
