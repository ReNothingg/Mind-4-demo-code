...
static void mf4_f32_convert(benchmark::State &state)
{
    ...
    Function mf4_f32_convert_fn{library, "mindfour_mf4_f32_convert"};
    Buffer block_buffer{device, num_bytes};
    Buffer scale_buffer{device, num_blocks * sizeof(mindfour_float8ue8m0)};
    ...
    for (auto _ : state)
    {
        ...
        Check(mindfour_metal_command_buffer_encode_launch_mf4_f32_convert(
                  ...
                  num_elements),
              "mindfour_metal_command_buffer_encode_launch_mf4_f32_convert");
