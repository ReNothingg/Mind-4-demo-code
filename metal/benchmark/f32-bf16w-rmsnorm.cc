...
using mindfour::Check;
using namespace mindfour::metal;
...
static void f32_bf16w_rnsnorm(benchmark::State &state)
{
    ...
    Function f32_fill_random_fn{library, "mindfour_f32_fill_random"};
    Function bf16_fill_random_fn{library, "mindfour_bf16_fill_random"};
    Function f32_bf16w_rmsnorm_fn{library, "mindfour_f32_bf16w_rmsnorm"};
    Buffer input_buffer{device, num_tokens * num_channels * sizeof(float)};
    Buffer weight_buffer{device, num_channels * sizeof(mindfour_bfloat16)};
    ...
    for (auto _ : state)
    {
        ...
        Check(mindfour_metal_command_buffer_encode_launch_f32_bf16w_rmsnorm(
                  command_buffer.handle(),
                  ...
                  num_channels,
                  kEpsilon),
              "mindfour_metal_command_buffer_encode_launch_f32_bf16w_rmsnorm");
