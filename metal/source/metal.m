...
static size_t mindfour_metal_device_get_core_count(id<MTLDevice> device) {
    if (!device) {
        return 0;
    }
    ...
    if (kr != KERN_SUCCESS) {
        mindfour_LOG_ERROR("failed to find IOAccelerator objects: error %d", kr);
        return 0;
    }
    ...
    struct mindfour_metal_device* device_out)
{
    ...
    if (device_obj == nil) {
        mindfour_LOG_ERROR("failed to create Metal device");
        return mindfour_status_unsupported_system;
    }

    device_out->object = (void*) device_obj;
    device_out->num_cores = mindfour_metal_device_get_core_count(device_obj);
    ...
    struct mindfour_metal_device* device)
{
    ...
    memset(device, 0, sizeof(struct mindfour_metal_device));
    return mindfour_status_success;
}
    ...
    struct mindfour_metal_library* library_out)
{
    ...
    if (library_data != NULL) {
        ...
        if (library_obj == nil) {
            mindfour_LOG_ERROR("failed to create Metal library: %s", [[error_obj localizedDescription] UTF8String]);
            status = mindfour_status_unsupported_system;
            goto cleanup;
        }
    } else {
        ...
        if (library_obj == nil) {
            mindfour_LOG_ERROR("failed to create Metal default library");
            status = mindfour_status_unsupported_system;
            goto cleanup;
        }
    }

    *library_out = (struct mindfour_metal_library) {
    ...
    struct mindfour_metal_library* library)
{
    ...
    memset(library, 0, sizeof(struct mindfour_metal_library));
    return mindfour_status_success;
}
    ...
    struct mindfour_metal_function* function_out)
{
    ...
    if (function_obj == nil) {
        mindfour_LOG_ERROR("failed to create Metal function %s", name);
        status = mindfour_status_unsupported_system;
        goto cleanup;
    }
    ...
    if (pipeline_state_obj == nil) {
        ...
        mindfour_LOG_ERROR("failed to create Metal compute pipeline state for function %s: %s",
            name, error_string);
        status = mindfour_status_unsupported_system;
        goto cleanup;
    }
    ...
    struct mindfour_metal_function* function)
{
    ...
    memset(function, 0, sizeof(struct mindfour_metal_function));
    return mindfour_status_success;
}
    ...
    struct mindfour_metal_buffer* buffer_out)
{
    ...
    if (buffer_obj == nil) {
        mindfour_LOG_ERROR("failed to create Metal buffer of size %zu", size);
        return mindfour_status_unsupported_system;
    }
    ...
    struct mindfour_metal_buffer* buffer_out)
{
    ...
    if (buffer_obj == nil) {
        mindfour_LOG_ERROR("failed to wrap Metal buffer of size %zu", size);
        return mindfour_status_unsupported_system;
    }
    buffer_out->object = (void*) buffer_obj;
    buffer_out->size = size;
    ...
    struct mindfour_metal_buffer* buffer)
{
    ...
    memset(buffer, 0, sizeof(struct mindfour_metal_buffer));
    return mindfour_status_success;
}
    ...
    struct mindfour_metal_command_queue* command_queue_out)
{
    ...
    if (command_queue_obj == nil) {
        mindfour_LOG_ERROR("failed to create Metal command queue");
        return mindfour_status_unsupported_system;
    }
    ...
    struct mindfour_metal_command_queue* command_queue)
{
    ...
    memset(command_queue, 0, sizeof(struct mindfour_metal_command_queue));
    return mindfour_status_success;
}
    ...
    struct mindfour_metal_command_buffer* command_buffer_out)
{
    ...
    if (command_buffer_obj == nil) {
        mindfour_LOG_ERROR("failed to create Metal command buffer");
        return mindfour_status_unsupported_system;
    }
    ...
    struct mindfour_metal_command_buffer* command_buffer)
{
    ...
    memset(command_buffer, 0, sizeof(struct mindfour_metal_command_buffer));
    return mindfour_status_success;
}
