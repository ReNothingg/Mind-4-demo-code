...
kernel void mindfour_f32_topk_softmax_e128_k4(
    constant mindfour_topk_args& args [[ buffer(0) ]],
    const device float4* input [[ buffer(1) ]],
    device mindfour_expert_prediction* output [[ buffer(2) ]],
    ...
    uint tid [[thread_position_in_threadgroup]])
{
    ...
    if (metal::simd_is_first()) {
        ...
        output[0] = (mindfour_expert_prediction) {
            .expert_id = topidx0,
            .score = topexp0 * scale,
        };
        output[1] = (mindfour_expert_prediction) {
            .expert_id = topidx1,
            .score = topexp1 * scale,
        };
        output[2] = (mindfour_expert_prediction) {
            .expert_id = topidx2,
            .score = topexp2 * scale,
        };
        output[3] = (mindfour_expert_prediction) {
            .expert_id = topidx3,
            .score = topexp3 * scale,
        };
    }
...
[[max_total_threads_per_threadgroup(32)]]
kernel void mindfour_f32_topk_softmax_e32_k4(
    constant mindfour_topk_args& args [[ buffer(0) ]],
