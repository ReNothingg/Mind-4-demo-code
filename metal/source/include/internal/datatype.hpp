...
namespace mindfour
{
    ...
    template <>
    inline float upcast<float>(mindfour_bfloat16 bf16_value)
    {
    ...
    template <>
    inline float upcast<float>(mindfour_float16 fp16_value)
    {
        return static_cast<float>(std::bit_cast<_Float16>(fp16_value.bits));
    }

    template <>
    inline float upcast<float>(mindfour_float8e4m3 fp8_value)
    {
        ...
        const mindfour_bfloat16 bf16_value{.bits = fp8e4m3_to_fp32[fp8_value.bits]};
    ...
    template <>
    inline double upcast<double>(mindfour_bfloat16 bf16_value)
    {
    ...
    template <>
    inline double upcast<double>(mindfour_float16 fp16_value)
    {
    ...
    template <>
    inline double upcast<double>(mindfour_float8e4m3 fp8_value)
    {
