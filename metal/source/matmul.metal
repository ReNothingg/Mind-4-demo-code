...
kernel void mindfour_f32_bf16w_matmul(
    constant mindfour_matmul_args& args [[ buffer(0) ]],
...
kernel void mindfour_f32_bf16w_unembedding(
    constant mindfour_unembedding_args& args [[ buffer(0) ]],
    const device float4* input [[ buffer(1) ]],
    const device bfloat4* weight [[ buffer(2) ]],
