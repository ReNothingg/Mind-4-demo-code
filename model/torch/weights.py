# ЭТО ТОЖЕ ОЧЕНЬ ВАЖНЫЙ ФАЙЛ! НЕ ТРОГАЙТЕ ЕГО!!! ТУТ ЗНАЧЕНИЯ НАДО КОРРЕКТИРОВАТЬ ДО СОТЫХ!
...
class Checkpoint:
    ...
    # Вот этот вариант жрет много памяти, но он короче и более простой
    def _get_mxfp4_tensor_copy(self, blocks_name: str, scales_name: str, dtype: torch.dtype = torch.bfloat16):
        ...
        loaded_scales = loaded_scales.int() - 127 # Честн не знаю. Тестировал на многих устройствах и их штырило. Пускай будет 127 мб.
